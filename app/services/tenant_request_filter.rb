class TenantRequestFilter
  ...
  def call
    ...
    scope
      .includes(:house, :requestable, :resolved_by)
  ...
  attr_reader :tenant, :params, :current_house_id, :house_id,
  ...
  def apply_house_filter(scope)
    # If house_id param was explicitly provided:
    if params.key?(:house_id)
      ...
      # Default to current house if no house_id param was set
